...
export const CHEST_LOOT_TABLE = [
    { item: 'gold', weight: 28, minQty: 50, maxQty: 200 },
    { item: 'cannonball', weight: 22, minQty: 3, maxQty: 8 },
    { item: 'banana', weight: 18, minQty: 1, maxQty: 3 },
    { item: 'wood_plank', weight: 18, minQty: 1, maxQty: 4 },
    { item: 'coconut', weight: 14, minQty: 1, maxQty: 2 },
    { item: 'mango', weight: 14, minQty: 1, maxQty: 2 },
    { item: 'firebomb_ball', weight: 10, minQty: 1, maxQty: 2 },
    { item: 'chainshot', weight: 8, minQty: 1, maxQty: 2 },
    { item: 'flintlock_ammo', weight: 0, minQty: 2, maxQty: 5 },
    { item: 'blunderbuss_ammo', weight: 14, minQty: 2, maxQty: 5 },
    { item: 'eye_ammo', weight: 10, minQty: 2, maxQty: 4 },
    { item: 'flintknock_ammo', weight: 20, minQty: 2, maxQty: 4 },
    { item: 'pistol_ammo', weight: 15, minQty: 3, maxQty: 8 },
];
/** Supplies on island resource barrels (Sea of Thieves style) */
export const BARREL_LOOT_TABLE = [
    { item: 'banana', weight: 22, minQty: 1, maxQty: 3 },
    { item: 'coconut', weight: 18, minQty: 1, maxQty: 2 },
    { item: 'mango', weight: 18, minQty: 1, maxQty: 2 },
    { item: 'meat', weight: 8, minQty: 1, maxQty: 2 },
    { item: 'wood_plank', weight: 20, minQty: 1, maxQty: 3 },
    { item: 'cannonball', weight: 14, minQty: 2, maxQty: 6 },
    { item: 'firebomb_ball', weight: 6, minQty: 1, maxQty: 1 },
    { item: 'chainshot', weight: 5, minQty: 1, maxQty: 2 },
];
export const POCKET = {
    FRUIT_HEAL: 22,
    MEAT_HEAL: 36,
