...
| `metal_plate` | Metal Plate | https://polyhaven.com/a/metal_plate | Rob Tuytel | CC0 1.0 | Diffuse, nor_gl, arm (1k) | 2026-09-26 | scripts/blender/build_weapons.py (steel blade, iron barrels, brass furniture, scope glass, flint: tinted, metalness per PLAN 3.12) |
| `walnut_veneer` | Walnut Veneer | https://polyhaven.com/a/walnut_veneer | Jenelle van Heerden | CC0 1.0 | Diffuse, nor_gl, arm (1k) | 2026-09-26 | scripts/blender/build_weapons.py (gun stocks, ramrods) |
| `brown_leather` | Brown Leather | https://polyhaven.com/a/brown_leather | Rob Tuytel | CC0 1.0 | Diffuse, nor_gl, arm (1k) | 2026-09-26 | scripts/blender/build_weapons.py (cutlass grip) |
