...
export const LOGIC = [
  ...
  // invite URL <-> party code round trip (4 + 6 chars), share vs honest copy.
  quick(tsx('test-front-door.mjs')),
  ...
  quick(tsx('test-island-wading.mjs')), // b2-ask-01: island shallows wade is a 0.55x walk CAP (crouch-aware), not a per-tick multiply that compounded with ground accel to 0.03-0.16x
  quick(tsx('test-ship-hold-cull.mjs')), // b2-device-04: a sealed hull beyond 60 m skips its hold-only meshes (galleon -15k verts), open breach / sinking / own hull / near always draw it
