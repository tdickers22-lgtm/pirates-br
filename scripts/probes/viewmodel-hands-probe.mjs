// PROBE, not a gate: Hands-on-every-weapon audit: for each weapon/tool and each animation state, project the first-person hand meshes to NDC and report whether a fist i...
