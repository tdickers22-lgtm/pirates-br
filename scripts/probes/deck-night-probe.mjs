// PROBE, not a gate: Night-readability probe for the OWN ship's deck and the lagoon shallows: the two frames the "night is a blackout" and "grazing water is a flat cyan...
