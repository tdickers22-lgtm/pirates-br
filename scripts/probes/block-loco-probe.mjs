#!/usr/bin/env node
// PROBE, not a gate: LIVE PROBE: is a held cutlass guard steady, and does on-foot walking stick? Two audit findings that only a real client can settle: • BLOCK — hold R...
