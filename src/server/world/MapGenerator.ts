...
import type { Island, IslandBarrel, IslandDock, IslandNpc, IslandProfile, ItemType, TreasureChest, UpgradeStation, ShipUpgradeType, Vec3, Ship } from '../../shared/types/index.js';
...
export class MapGenerator {
  ...
  private generateIslandProfile(radius: number): IslandProfile {
